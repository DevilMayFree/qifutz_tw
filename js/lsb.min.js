!function (t) {
    ...
    t.fn.lightspeedBox = function (e) {
        ...
        }, a = t.extend(i, e), v = 400, b = !0, m = {
            current: null, images: [], getImagesInSet: function (e) {
                var i, s = [], n = 0, o = e.attr("href"), l = e.find("img").attr("alt"), r = e.attr("data-lsb-group");
                r ? (i = t('.lsb-preview[data-lsb-group="' + r + '"]'), i.each(function (e, i) {
                    var a = i.getAttribute("href"), l = t(i).find("img").attr("alt");
        ...
        function g(t) {
            if (1 === i) {
                ...
                var l = t.clientX - a, r = t.clientY - s;
                (Math.abs(l) > e.swipeThreshold || Math.abs(r) > e.swipeThreshold) && (i = 2, n = l, o = r)
            }
        }

        var i = 0, a = 0, s = 0, n = 0, o = 0, l = this, r = {swipeThreshold: 70, useOnlyTouch: !0};
        return function () {
